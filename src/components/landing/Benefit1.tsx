...
export function Benefit1() {
  ...
  return (
    <section
      ...
      className="scroll-mt-16 w-full bg-ink bg-[repeating-linear-gradient(to_right,var(--color-charcoal-900)_0,var(--color-charcoal-900)_1px,transparent_1px,transparent_80px)] px-5 py-16 lg:px-20 lg:py-24"
    >
